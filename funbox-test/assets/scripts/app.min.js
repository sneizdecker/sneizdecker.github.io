...
/******/ 	var hotCurrentHash = "edb9920e60bcd9db2273"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	(0, _jquery2.default)(function () {
		...
		var $buyLink = (0, _jquery2.default)('.link');
		var $disabled = 'product_state_disabled';
		var $hovered = 'product_state_hovered';
		var $selected = 'product_state_selected';
	
		// Card hovering
		$card.hover(function (e) {
			var $product = (0, _jquery2.default)(this).parents('.product');
			if ($product.hasClass($disabled) === false) {
				$product.addClass($hovered);
				e.preventDefault();
			}
		}, function (e) {
			(0, _jquery2.default)(this).parents('.product').removeClass($hovered);
			e.preventDefault();
		});
	
		// Card selecting
		_jquery2.default.fn.selectCard = function () {

...
/******/ 	var hotCurrentHash = "bd50312045ecd0dff8d4"; // eslint-disable-line no-unused-vars
...
/***/ function(module, exports, __webpack_require__) {
	...
	var range = (0, _jquery2.default)('.skills-slider__label');
	var pointer = (0, _jquery2.default)('.skills-slider__pointer');
	
	range.click(function () {
		var currentRange = pointer.attr('class').split(' ').slice(1);
		var chosenRange = (0, _jquery2.default)(this).attr('class').split(' ').slice(1);
